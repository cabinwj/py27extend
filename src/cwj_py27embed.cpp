...
int py27embed::init(ipy27init_module* init_module)
{
    ...
    rc = PyRun_SimpleString("sys.path.append('/usr/local/python27')");
    rc = PyRun_SimpleString("sys.path.append('/usr/local/python27/lib')");
    rc = PyRun_SimpleString("sys.path.append('/usr/local/python27/lib/site-packages')");
